...
export default function DayScheduleInfo({ daySchedule }: DayScheduleInfoProps) {
      ...
      {daySchedule.incomplete_block && (
        <div className="mb-3">
          ...
          <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-md p-3">
            <div className="text-xs text-gray-600 dark:text-gray-400">
              <div>Origin: {daySchedule.incomplete_block.origin_airport}</div>
              <div className="mt-1">
                Completed: {daySchedule.incomplete_block.completed_legs.length}{" "}
                legs
              </div>
              <div className="mt-1">
                Remaining:{" "}
            ...
            {daySchedule.legs.map((leg, index) => (
              ...
              >
                ...
                <div className="text-xs text-gray-600 dark:text-gray-400 space-y-1">
                  ...
                  {leg.distance_km && <div>Distance: {leg.distance_km} km</div>}
